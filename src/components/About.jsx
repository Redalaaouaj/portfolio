        ...
        <div className='max-w-7xl mx-auto my-14 md:py-8 px-7' id='about'>
            ...
            <div className='flex flex-col md:flex-row items-start justify-start'>
                ...
                className='md:w-1/2 my-8'>
                    ...
                    <p className='mb-5'>I'm a <strong>FullStack Web Developer</strong> building the Front-end of Websites and Web Applications that leads to the success of the overall product. Check out some of my work in the <strong>Projects</strong> section.</p>

                    <p className='mb-5'>I also like sharing content related to the stuff that I have learned over the years in <strong>Web Development</strong> so it can help other people of the Dev Community. Feel free to Connect or Follow me on my <a target="_blank" rel="noreferrer" href="https://www.linkedin.com/in/reda-laaouaj-24b0331b6/" className='text-secondary font-bold underline'>Linkedin</a> where I post useful content related to Web Development and Programming</p>
